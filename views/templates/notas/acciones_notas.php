    ...
    <tr>
        <td>
            ...
            <form method="POST" action="/views/notas_view.php?view=true">
                ...
                <textarea name="descrip_nota" placeholder="Nueva descripcion" required><?php echo $nota['descrip_nota']; ?></textarea>
                <input type="number" name="porcentaje" value="<?php echo $nota['porcentaje']; ?>" placeholder="Nuevo porcentaje" required>
                <input type="number" name="posicion" value="<?php echo $nota['posicion']; ?>" placeholder="Nueva posicion" required>
